...
// All implementations must embed UnimplementedNFSSServer
...
// UnimplementedNFSSServer must be embedded to have forward compatible implementations.
...
func (UnimplementedNFSSServer) mustEmbedUnimplementedNFSSServer() {}
